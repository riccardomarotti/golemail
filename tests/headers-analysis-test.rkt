  ...
  (list
   (test-suite
    ...
    (test-case
     ...
     (define same-sender-and-receiver-message (message same-sender-and-receiver-header "any id" "any position"))
     ...
     (define another-message (message another-header "anuy other id" "any position"))
    ...
    (test-case
     ...
     (define message-from-sender (message header-from-sender "any id" "any position"))
     ...
     (define message-from-another-sender (message header-from-another-sender "any other id" "any other position"))
    ...
    (test-case
     ...
     (define not-a-reminder-message (message not-a-reminder-header "any id" "any position"))
     (define a-reminder-header (insert-field #"Subject" #"any text oggi alle 10.>>>" (string->bytes/utf-8 empty-header)))
     (define a-reminder-message (message a-reminder-header "a reminder id" "any other position"))
